                            ...
                            @foreach ($category as $row => $index)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link {{ $row == 0 ? 'active' : '' }}" id="pills-popular-tab"
                                        data-bs-toggle="pill" data-bs-target="#pills-popular{{ $index->id }}"
                                        type="button" role="tab" aria-controls="pills-popular{{ $index->id }}"
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            @foreach ($category as $row => $index)
                                <div class="tab-pane fade show {{ $row == 0 ? 'active' : '' }}"
                                    id="pills-popular{{ $index->id }}" role="tabpanel"
